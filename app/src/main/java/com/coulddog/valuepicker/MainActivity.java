...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectorView = (SelectorView) findViewById(R.id.selectorView);
        adapter = new SelectorViewAdapter(selectorViewDialogDelegate, testList);
//        adapter.setTitle(title);
    ...
    private SelectorViewDialogDelegate selectorViewDialogDelegate = new SelectorViewDialogDelegate() {
        @Override
        public void showDialog(@NonNull List<? extends Checkable> values, @NonNull String title, @NonNull SelectionMode mode, @NonNull SelectionDialogCallback callback) {
